...
Follow-up: [service-response definition, category decomposition and sensitivity](immigration-service-response-sensitivity-2026-09-20.md) separates the uniform break-even threshold from evidence about actual incremental costs; [external evidence](immigration-service-response-external-evidence-2026-09-20.md) checks CBO, NASEM, GAO and local causal evidence. Neither establishes a national long-run response coefficient.
