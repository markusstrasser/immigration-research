...
<doc path='research/iq-sex-differences-master-plan.md'>
...
**Goal:** see how much the gap moves under invariant-item rescoring.
...
**Decision rule:** if the sign or a large share of the magnitude moves under invariant-item rescoring, no broad latent claim should be made from the raw score surface.
...
**Goal:** estimate whether broad early math is near zero at entry and then moves male after schooling begins.
...
<doc path='research/iq-sex-differences-item-face-validity-audit.md'>
