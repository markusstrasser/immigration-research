...
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/arch-extraction.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/arch-extraction.meta.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/arch-extraction.parsed.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/arch-output.md
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/arch-output.meta.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/coverage.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/disposition.md
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/findings.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/formal-extraction.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/formal-extraction.meta.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/formal-extraction.parsed.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/formal-output.md
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/formal-output.meta.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/shared-context.manifest.json
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/shared-context.md
?? .model-review/2026-04-22-immigration-capacity-falsification-close-e507ed/verified-disposition.md
...
research/immigration-INDEX.md                      |   8 +-
 ...ation-causal-internal-vs-immigrant-newcomers.md | 163 +++++----------------
 ...-causal-paradigm-escape-synthesis-2026-04-18.md |   2 +-
 research/immigration-confidence-ladder.md          |   6 +-
 sources/immigration-causal/README.md               |  11 +-
 .../analyze_internal_vs_immigrant_newcomers.py     | 120 ++++++++-------
 6 files changed, 127 insertions(+), 183 deletions(-)
```
...
research/immigration-causal-internal-vs-immigrant-newcomers.md --- Text
  1 # Internal native migration vs inte   1 # Domestic migration vs moved-from-
  . rnational immigration as newcomer s   . abroad counts
  . hocks                                 . 
  2                                       2 
  3 **Date:** 2026-04-18                  3 **Date:** 2026-04-22  
  4 **Question:** Is "immigrant" or "ne   4 **Question:** For county-level newc
  . wcomer in general" the right unit o   . omer pressure, is the relevant obje
  . f analysis for the school/housing/c   . ct immigration specifically or newc
  . apacity burden discussion in the ex   . omer flow more generally?  
  . isting repo?                          . 
  5 **Answer:** **Newcomer in general**   5 **Answer:** County newcomer counts 
  . , by a wide margin. US-native cross   . are much larger on the domestic sid
  . -county migration is **~33× larger    . e than on the moved-from-abroad sid
  . per capita per year** than recent i   . e, but the comparison is descriptiv
  . nternational immigration at the med   . e, not like-for-like causal account
  . ian county. Restricting immigration   . ing. The current median county with
  .  cannot fix the bulk of newcomer-dr   .  `totpop >= 10k` shows about `4.49%
  . iven local burden because most newc   . ` IRS `Total Migration-US` inflow v
  . omer flow IS native.                  . ersus about `0.21%` ACS `Moved from
  .                                       .  abroad` in the past year, or rough
  .                                       . ly `20.5x`. [SOURCE: sources/immigr
  .                                       . ation-causal/data/analysis/county_n
  .                                       . ewcomer_comparison.parquet]
  6                                       6 
  7 ## Bottom line                        7 ## Status
  8                                       8 
  9 The existing repo's `low-skill-orig   9 This memo supersedes the older `33x
  ...
  .  with ACS recent-arrival foreign-bo   . ernal_vs_immigrant_newcomers.py](/U
  . rn data shows this is wrong by a fa   . sers/alien/Projects/research/source
  . ctor of 33×. Median US county recei   . s/immigration-causal/scripts/analyz
  . ves 3.00% of population per year as   . e_internal_vs_immigrant_newcomers.p
  .  native US-inflow; same county rece   . y). Treat older citations to `33x` 
  . ives 0.08% as recent foreign-born a   . as outdated. [SOURCE: sources/immig
  . nnual flow. **The newcomer-burden f   . ration-causal/scripts/analyze_inter
  . rame should disaggregate native-new   . nal_vs_immigrant_newcomers.py]
  . comer from immigrant-newcomer becau   . 
  . se they are different orders of mag   . 
  . nitude with different policy levers   . 
  . .**                                   . 
 10                                      10 
 11 This does not erase the immigrant-s  11 ## What The Data Actually Compare
 .. pecific story (concentration, langu  .. 
 .. age, household composition, legal s  .. 
 .. tatus all still matter). But it sha  .. 
 .. rply revises the frame: most "newco  .. 
 .. mer" pressure on US counties is int  .. 
 .. ernal migration, which immigration   .. 
 .. policy cannot touch.                 .. 
 12                                      12 
 13 **Confidence:** HIGH on the absolut  13 1. **IRS SOI `97/000` inflow**: `To
 .. e size disparity (IRS SOI counts ta  .. tal Migration-US` into a county in 
 .. x filers — administrative data, not  .. `2022–2023`, measured from tax-file
 ..  survey). MEDIUM on the per-newcome  .. r returns and exemptions. This is n
 .. r burden parity (composition differ  .. ot a native-only series and it miss
 .. s: military families, retirees, rem  .. es some movers. [SOURCE: sources/im
 .. ote workers vs labor-migrant immigr  .. migration-causal/scripts/analyze_in
 .. ants).                               .. ternal_vs_immigrant_newcomers.py]
 ..                                      14 2. **ACS `B07001_081E`**: people ag
 ..                                      .. e `1+` who `moved from abroad` in t
 ..                                      .. he past year, from the `2022` ACS `
 ..                                      .. 5-year` file. This is not an immigr
 ..                                      .. ant-only series; it can include ret
 ..                                      .. urning U.S. citizens and other inte
 ..                                      .. rnational movers. [SOURCE: sources/
 ..                                      .. immigration-causal/scripts/analyze_
 ..                                      .. internal_vs_immigrant_newcomers.py]
 ..                                      15 3. **Denominators differ from the e
 ..                                      .. arlier memo**: the ACS moved-from-a
 ..                                      .. broad share now uses `B07001_001E` 
 ..                                      .. (population age `1+`) rather than t
 ..                                      .. otal population. [SOURCE: sources/i
 ..                                      .. mmigration-causal/scripts/analyze_i
 ..                                      .. nternal_vs_immigrant_newcomers.py]
 14                                      16 
 15 ## Method                            17 ## Current Descriptive Facts
 16                                      18 
 17 ### Data                             19 Using counties with `totpop >= 10k`
 ..                                      .. :
 18 - **IRS SOI county-to-county migrat  .. 
 .. ion 2022-2023** — administrative ta  .. 
 .. x-filer migration. Aggregate row co  .. 
 .. de y1=97 = "Total Migration-US" (ex  .. 
 .. cludes foreign). 4.6 MB CSV per fil  .. 
 .. e (inflow + outflow). Reports numbe  .. 
 .. r of returns, exemptions, and aggre  .. 
 .. gate AGI by destination county. [SO  .. 
 .. URCE: irs.gov/pub/irs-soi/countyinf  .. 
 .. low2223.csv]                         .. 
 19 - **ACS 2022 5-yr** — county-level   .. 
 .. B01003 (totpop), B05002 (foreign-bo  .. 
 .. rn stock), B05005_002E (foreign-bor  .. 
 .. n entered 2010-or-later, ≈ recent a  .. 
 .. rrivals 12-year window), B25064 (me  .. 
 .. dian rent), B19013 (median income).  .. 
 20 - **Match:** state_fips × county_fi  .. 
 .. ps (FIPS5). 9,120 county-merged row  .. 
 .. s after one-to-many join (county-fi  .. 
 .. ps repeated due to multiple inflow   .. 
 .. source rows; stylized facts use med  .. 
 .. ians robust to this).                .. 
 21                                      20 
 22 ### Definitions                      21 1. Median IRS `Total Migration-US` 
 ..                                      .. inflow share: about `4.49%`. [SOURC
 ..                                      .. E: sources/immigration-causal/data/
 ..                                      .. analysis/county_newcomer_comparison
 ..                                      .. .parquet]
 23 - "Native US-inflow" = aggregate an  22 2. Median ACS moved-from-abroad sha
 .. nual exemption count moving across   .. re: about `0.21%`. [SOURCE: sources
 .. counties from anywhere in the US (p  .. /immigration-causal/data/analysis/c
 .. er IRS SOI). Most are US-born; smal  .. ounty_newcomer_comparison.parquet]
 .. l share are settled foreign-born al  .. 
 .. ready in the US who change county.   .. 
 ..                                      23 3. Median ratio of the two shares: 
 ..                                      .. about `20.5x`. [SOURCE: sources/imm
 ..                                      .. igration-causal/data/analysis/count
 ..                                      .. y_newcomer_comparison.parquet]
 24 - "Recent foreign-born annual flow"  24 4. This ratio is best treated as a 
 ..  = foreign-born population entered   .. **lower-bound directional compariso
 .. 2010-or-later (per ACS B05005), div  .. n**, not a precise burden multiple.
 .. ided by 12 to annualize the 12-year  ..  IRS misses some domestic movers, w
 ..  accumulation.                       .. hile ACS moved-from-abroad includes
 ..                                      ..  some returning U.S. citizens, so t
 ..                                      .. he measured domestic-vs-foreign-ori
 ..                                      .. gin gap is likely understated if th
 ..                                      .. e comparison is interpreted as dome
 ..                                      .. stic-origin versus foreign-origin n
 ..                                      .. ewcomer flow. [INFERENCE]
 25 - Both measured as share of destina  .. 
 .. tion county population.              .. 
 26                                      25 
 27 ## Stylized facts                    26 ## Why This Still Matters
 28                                      27 
 29 ### Fact 1: native flow is ~33× lar  28 The repo should stop using “newcome
 .. ger per year                         .. r burden” as if it automatically me
 ..                                      .. ant immigration burden at the count
 ..                                      .. y level. County aggregates are pick
 ..                                      .. ing up a much broader mobility proc
 ..                                      .. ess. That does **not** mean immigra
 ..                                      .. tion-specific channels disappear:
 30 Median county (≥10,000 pop, n=7,286  .. 
 .. ):                                   .. 
 31 - Native US-inflow share: **3.00% p  .. 
 .. er year**                            .. 
 32 - Recent FB annual flow: **0.08% pe  .. 
 .. r year**                             .. 
 33 - Ratio: **33×**                     .. 
 34                                      29 
 35 ### Fact 2: top counties by NATIVE   30 1. immigrant concentration can stil
 .. inflow are military bases and Sun B  .. l matter more at neighborhood, scho
 .. elt exurbs                           .. ol, or shelter-node scale [INFERENC
 ..                                      .. E]
 36 | County | Pop | Inflow share | Med  .. 
 .. ian rent |                           .. 
 37 |--------|-----|--------------|----  .. 
 .. ---------|                           .. 
 38 | Geary County, KS (Fort Riley) | 3  .. 
 .. 6,247 | **16.4%** | $1,132 |         .. 
 39 | Long County, GA | 16,804 | 15.7%   31 2. language, legal status, and hous
 .. | $846 |                             .. ehold structure still make immigran
 ..                                      .. t inflows qualitatively different f
 ..                                      .. rom generic domestic movers [INFERE
 ..                                      .. NCE]
 40 | Liberty County, GA (Fort Stewart)  .. 
 ..  | 65,550 | 13.9% | $1,178 |         .. 
 41 | Kaufman County, TX (Dallas exurb)  .. 
 ..  | 149,773 | 13.6% | $1,286 |        .. 
 42 | Fredericksburg city, VA (DC exurb  32 3. countywide newcomer counts alone
 .. ) | 28,258 | 12.8% | $1,462 |        ..  cannot price those composition eff
 ..                                      .. ects [INFERENCE]
 43 | Comal County, TX (Austin exurb) |  .. 
 ..  165,201 | 11.4% | $1,390 |          .. 
 44 | Alexandria city, VA | 157,594 | 1  .. 
 .. 1.3% | $1,983 |                      .. 
 45                                      33 
 46 These places get 10-16% of their po  34 The clean correction is narrower:
 .. pulation REPLACED every year by nat  .. 
 .. ive US migrants. None of them are i  .. 
 .. mmigrant gateways.                   .. 
 47                                      35 
 48 ### Fact 3: top counties by RECENT   36 1. county newcomer totals are not i
 .. IMMIGRANT inflow are well-known imm  .. mmigration-specific by default [SOU
 .. igrant gateways                      .. RCE: sources/immigration-causal/dat
 ..                                      .. a/analysis/county_newcomer_comparis
 ..                                      .. on.parquet]
 49 | County | Pop | Annual FB flow | M  .. 
 .. edian rent |                         .. 
 50 |--------|-----|----------------|--  .. 
 .. -----------|                         .. 
 51 | Miami-Dade, FL | 2,688,237 | 1.5%  37 2. immigration-specific burden clai
 ..  | $1,623 |                          .. ms need a more targeted denominator
 ..                                      ..  and geography than this county com
 ..                                      .. parison provides [INFERENCE]
 52 | Osceola, FL | 393,745 | 1.4% | $1  .. 
 .. ,537 |                               .. 
 53 | Hudson, NJ | 712,029 | 1.3% | $1,  .. 
 .. 722 |                                .. 
 54 | Colfax, NE (meatpacking) | 10,563  .. 
 ..  | 1.3% | $907 |                     .. 
 55 | Santa Clara, CA | 1,916,831 | 1.1  .. 
 .. % | $2,719 |                         .. 
 56                                      38 
 57 Note these "highest-immigrant-inflo  39 ## Limits
 .. w" counties top out at ~1.5%, while  .. 
 ..  top native-inflow counties exceed   .. 
 .. 16%. **The most-immigrant-saturated  .. 
 ..  county in America still receives o  .. 
 .. ne-tenth the per-capita newcomer fl  .. 
 .. ow of the most-native-saturated cou  .. 
 .. nty.**                               .. 
 58                                      40 
 59 ### Fact 4: rent gradient by inflow  41 1. IRS SOI counts tax-filer units a
 ..  type quintile                       .. nd dependents, not a full resident 
 ..                                      .. universe. [SOURCE: sources/immigrat
 ..                                      .. ion-causal/scripts/analyze_internal
 ..                                      .. _vs_immigrant_newcomers.py]
 ..                                      42 2. ACS `B07001_081E` is a `5-year` 
 ..                                      .. pooled estimate, so it is not a sha
 ..                                      .. rp `2022–2023` county flow. [SOURCE
 ..                                      .. : sources/immigration-causal/script
 ..                                      .. s/analyze_internal_vs_immigrant_new
 ..                                      .. comers.py]
 ..                                      43 3. The current script flags countie
 ..                                      .. s where ACS moved-from-abroad MOE i
 ..                                      .. s at least as large as the estimate
 ..                                      .. ; those counties should be treated 
 ..                                      .. cautiously. [SOURCE: sources/immigr
 ..                                      .. ation-causal/scripts/analyze_intern
 ..                                      .. al_vs_immigrant_newcomers.py]
 ..                                      44 4. None of this identifies school b
 ..                                      .. urden, shelter burden, or wage inci
 ..                                      .. dence directly. It is a frame-corre
 ..                                      .. ction artifact, not a causal burden
 ..                                      ..  model. [INFERENCE]
 60                                      45 
 61 By US-NATIVE inflow quintile:        46 ## Repo Implication
 62 | Quintile | Inflow share | Median   .. 
 .. rent | Median income | FB share |    .. 
 63 |----------|--------------|--------  .. 
 .. -----|---------------|----------|    .. 
 64 | Q1 | 1.0% | $803 | $59,707 | 2.3%  .. 
 ..  |                                   .. 
 65 | Q5 | 5.7% | $960 | $66,154 | 4.1%  .. 
 ..  |                                   .. 
 66 | Δ | +5.7× | +20% | +11% | +1.8 pp  .. 
 ..  |                                   .. 
 67                                      47 
 68 By RECENT-FB inflow quintile:        48 Future county-level memos should sa
 ..                                      .. y one of the following, not “immigr
 ..                                      .. ant newcomer burden” by default:
 69 | Quintile | FB inflow share | Medi  .. 
 .. an rent | Median income | US inflow  .. 
 ..  |                                   .. 
 70 |----------|-----------------|-----  .. 
 .. --------|---------------|----------  .. 
 .. -|                                   .. 
 71 | Q1 | 0.02% | $752 | $55,242 | 2.8  .. 
 .. % |                                  .. 
 72 | Q5 | 0.32% | $1,200 | $72,532 | 3  .. 
 .. .0% |                                .. 
 73 | Δ | +18× | +60% | +31% | +0.2 pp   .. 
 .. |                                    .. 
 74                                      49 
 75 **Reading:** Per percentage-point o  50 1. `domestic newcomer flow`
 .. f inflow, immigrant inflow is corre  .. 
 .. lated with much larger rent and inc  .. 
 .. ome differences than native inflow.  .. 
 ..  But in absolute terms, the native   .. 
 .. flow is 18× larger at the top quint  .. 
 .. ile, and the rent gradient is only   .. 
 .. 60% (vs 20% for native). This is co  .. 
 .. nsistent with the prior cycle's Sai  .. 
 .. z finding: immigrants concentrate i  .. 
 .. n inelastic high-cost MSAs, so thei  .. 
 .. r inflow correlates with rent more   .. 
 .. strongly per percentage point. Nati  .. 
 .. ve migrants spread more evenly, inc  .. 
 .. luding to elastic markets.           .. 
 ..                                      51 2. `moved-from-abroad flow`
 ..                                      52 3. `newcomer flow, mixed source`
 76                                      53 
 77 ## What this changes                 54 If a memo wants to make an immigrat
 ..                                      .. ion-specific burden claim, it needs
 ..                                      ..  a construct that actually isolates
 ..                                      ..  that burden rather than borrowing 
 ..                                      .. it from a mixed county newcomer cou
 ..                                      .. nt. [INFERENCE]
 78                                      55 
 79 ### The repo's "low-skill-origin-in  .. 
 .. cidence" frame                       .. 
 80 The existing memo treats origin × d  .. 
 .. estination heterogeneity in immigra  .. 
 .. nt inflows as the central object. T  .. 
 .. his is correct for *immigration-spe  .. 
 .. cific* questions (origin culture, l  .. 
 .. anguage, legal status, remittance f  .. 
 .. lows). But for *newcomer-burden* qu  .. 
 .. estions (school capacity, rental ma  .. 
 .. rket pressure, service demand), the  .. 
 ..  frame is wrong: the dominant newco  .. 
 .. mer flow into US counties is native  .. 
 .. , not immigrant.                     .. 
 81                                      .. 
 82 Concretely:                          .. 
 83 - A county receiving 12% native + 1  .. 
 .. % immigrant inflow has a school-bur  .. 
 .. den problem driven 92% by natives    .. 
 84 - Restricting immigration in such a  .. 
 ..  county would reduce newcomer burde  .. 
 .. n by ~7%, not eliminate it           .. 
 85 - The Texas exurbs (Comal, Kaufman,  .. 
 ..  Rockwall — all in the top-15 nativ  .. 
 .. e-inflow list) are growing rapidly   .. 
 .. NOT because of immigration           .. 
 86                                      .. 
 87 ### The political-economy frame      .. 
 88 Two competing readings of "immigran  .. 
 .. ts are changing my town":            .. 
 89 1. **Quantitative reading:** newcom  .. 
 .. ers are arriving fast → schools/hou  .. 
 .. sing strain. *In this reading, the   .. 
 .. data show the strain is mostly nati  .. 
 .. ve-driven, and immigration is a sma  .. 
 .. ll component.*                       .. 
 90 2. **Compositional reading:** newco  .. 
 .. mers are different from incumbents   .. 
 .. in language/culture/visibility → in  .. 
 .. tegration concerns. *In this readin  .. 
 .. g, the immigrant share matters beca  .. 
 .. use of what immigrants are, not how  .. 
 ..  many they are.*                     .. 
 91                                      .. 
 92 Repository memos have not consisten  .. 
 .. tly distinguished these two reading  .. 
 .. s. The mainstream restrictionist ca  .. 
 .. se rests heavily on reading #1; the  .. 
 ..  data side with #2.                  .. 
 93                                      .. 
 94 ### Confidence ladder                .. 
 95 Add to `immigration-confidence-ladd  .. 
 .. er.md`:                              .. 
 96 - New entry: **`Native US migration  .. 
 ..  is the dominant newcomer flow into  .. 
 ..  US counties; immigration is a smal  .. 
 .. l fraction in absolute terms`** — `  .. 
 .. STRONG`. Median county receives 3.0  .. 
 .. % native + 0.08% immigrant inflow p  .. 
 .. er year (33× ratio). [SOURCE: resea  .. 
 .. rch/immigration-causal-internal-vs-  .. 
 .. immigrant-newcomers.md]              .. 
 97                                      .. 
 98 ### Adversarial review §3 (school b  .. 
 .. urden too coarse)                    .. 
 99 The earlier review flagged that dis  .. 
 .. trict school-burden was under-model  .. 
 .. ed. This finding adds: **the school  .. 
 ..  burden of immigrant-origin childre  .. 
 .. n may be misattributed**. A distric  .. 
 .. t in Comal County TX (12% native in  .. 
 .. flow, low immigrant inflow) faces s  .. 
 .. chool capacity strain that is overw  .. 
 .. helmingly native-driven. A district  .. 
 ..  in Miami-Dade FL faces strain that  .. 
 ..  is more immigrant-driven. The righ  .. 
 .. t policy intervention differs.       .. 
100                                      .. 
101 ## Honest limits                     .. 
102                                      .. 
103 1. **Composition of native vs immig  .. 
... rant newcomers differs sharply.**    .. 
104    - Native newcomers in top-list c  .. 
... ounties: military families (Fort Ri  .. 
... ley, Fort Stewart), retirees (Flori  .. 
... da), DC-area government workers, ex  .. 
... urb developers                       .. 
105    - Immigrant newcomers in top-lis  .. 
... t counties: working-age labor migra  .. 
... nts, family-reunification, refugees  .. 
106    - Per-newcomer school enrollment  .. 
... , per-newcomer rent payment, per-ne  .. 
... wcomer wage competition all differ   .. 
107    - The "33× ratio" is gross flow   .. 
... ratio, not "burden equivalence"      .. 
108                                      .. 
109 2. **Geography of impact differs.**  .. 
110    - County aggregate masks within-  .. 
... county sorting                       .. 
111    - Immigrants concentrate in spec  .. 
... ific neighborhoods/PUMAs; natives s  .. 
... ort more diffusely                   .. 
112    - The local impact at the school  .. 
... -attendance-zone or ZIP level may h  .. 
... ave different relative magnitudes    .. 
113    - Texas exurbs (top native-inflo  .. 
... w) sprawl across new construction,   .. 
... so capacity can scale; older-city P  .. 
... UMAs in Miami-Dade can't             .. 
114                                      .. 
115 3. **IRS SOI undercount.**           .. 
116    - Tax filer migration misses non  .. 
... -filers (very-low-income, students,  .. 
...  undocumented)                       .. 
117    - These omissions affect the imm  .. 
... igrant comparison too — both sides   .. 
... probably undercounted                .. 
118    - Direction of bias on the ratio  .. 
...  is ambiguous                        .. 
119                                      .. 
120 4. **Annualization of B05005 12-yea  .. 
... r stock is rough.**                  .. 
121    - Recent FB flow is not constant  .. 
...  over 2010-2022                      .. 
122    - Mexican-origin flow declined 2  .. 
... 008-2018, NTCA flow rose 2018+       .. 
123    - The 0.08% number is a 12-year   .. 
... average, may understate 2020-2022 f  .. 
... low                                  .. 
124    - Even doubling it (0.16%) leave  .. 
... s a 19× ratio — the qualitative fin  .. 
... ding is robust to large adjustments  .. 
125                                      .. 
126 5. **What this does NOT settle.**    .. 
127    - Immigration's effect on school  .. 
... s, wages, rent at PUMA / neighborho  .. 
... od scale (where it's concentrated)   .. 
128    - The compositional integration   .. 
... concerns (language, cultural, visib  .. 
... ility)                               .. 
129    - Whether second-generation outc  .. 
... omes differ between high-native-inf  .. 
... low and high-immigrant-inflow count  .. 
... ies                                  .. 
130    - Federal fiscal incidence (stil  .. 
... l requires the SIPP fix from prior   .. 
... cycle)                               .. 
131                                      .. 
132 ## Decision-relevant claim           .. 
133                                      .. 
134 Any future repo memo that says "new  .. 
... comer burden in county X" without d  .. 
... istinguishing native-newcomer from   .. 
... immigrant-newcomer flow is using a   .. 
... misleading frame. The correct frami  .. 
... ng is: "X% of newcomer flow is nati  .. 
... ve (Y), Z% is immigrant (W)." Count  .. 
... y-level data routinely makes this d  .. 
... isaggregation, so there's no excuse  .. 
...  for the conflated frame.            .. 
135                                      .. 
136 For the project's central question   .. 
... ("which low-skill immigration flows  .. 
...  degrade local-system capacity"), t  .. 
... his finding doesn't kill the questi  .. 
... on — it adds a comparative anchor:   .. 
... most school/housing/service strain   .. 
... in fast-growing US counties is bein  .. 
... g absorbed without immigration as t  .. 
... he proximate cause. Wherever immigr  .. 
... ation IS the proximate cause (Miami  .. 
... -Dade, Hudson NJ, San Jose CA, Colf  .. 
... ax NE), it operates at much smaller  .. 
...  scale than internal native migrati  .. 
... on in equally-stressed Sun Belt exu  .. 
... rbs.                                 .. 
137                                      .. 
138 [SOURCE: data/internal_migration/co  .. 
... unty_inflow_2022_23.csv]             .. 
139 [SOURCE: data/analysis/county_newco  .. 
... mer_comparison.parquet]              .. 
140 [SOURCE: scripts/analyze_internal_v  .. 
... s_immigrant_newcomers.py]            .. 
141 [SOURCE: api.census.gov/data/2022/a  .. 
... cs/acs5 (B05005, B05002, B25064, B1  .. 
... 9013)]                               .. 
142                                      .. 
143 <!-- knowledge-index                 56 <!-- knowledge-index
144 generated: 2026-04-19T04:19:50Z      57 generated: 2026-04-22T23:59:00Z
145 hash: 309f7e3f68b3                   58 hash: current
146                                      59 
147 cross_refs: research/immigration-ca  60 cross_refs: research/immigration-co
... usal-internal-vs-immigrant-newcomer  .. nfidence-ladder.md, sources/immigra
... s.md                                 .. tion-causal/scripts/analyze_interna
...                                      .. l_vs_immigrant_newcomers.py
148                                      61 
149 end-knowledge-index -->              62 end-knowledge-index -->
...
PERMUTATIONS = 1000
THRESHOLD_SPLITS = 100
THRESHOLD_NULL_SPLITS = 100
...
def fetch_acs_county_population_and_recent_fb() -> pd.DataFrame:
    """Pull ACS 2022 5-yr county-level total population, foreign-born stock, rent, and income."""
...
def fetch_acs_moved_from_abroad() -> pd.DataFrame:
    ...
    url = "https://api.census.gov/data/2022/acs/acs5"
    params = {
        "get": "B07001_001E,B07001_081E,B07001_081M",
        "for": "county:*",
    }
    r = requests.get(url, params=params, timeout=120)
    r.raise_for_status()
    data = r.json()
    df = pd.DataFrame(data[1:], columns=data[0])
    df["population_age_1_plus"] = pd.to_numeric(df["B07001_001E"], errors="coerce")
    df["moved_from_abroad_past_year"] = pd.to_numeric(df["B07001_081E"], errors="coerce")
    df["moved_from_abroad_past_year_moe"] = pd.to_numeric(df["B07001_081M"], errors="coerce")
    df["state_fips"] = df["state"].astype(str).str.zfill(2)
    df["county_fips"] = df["county"].astype(str).str.zfill(3)
    df["fips5"] = df["state_fips"] + df["county_fips"]
    return df
...
erged["moved_from_abroad_moe_share"] = merged["moved_from_abroad_past_year_moe"] / merged["population_age_1_plus"]
        merged["moved_from_abroad_high_moe_flag"] = (
            merged["moved_from_abroad_past_year_moe"] >= merged["moved_from_abroad_past_year"]
        )
    ...
    merged["comparison_bias_direction"] = (
        "Domestic-vs-foreign newcomer gap is likely understated: IRS misses some domestic movers, "
        "while ACS moved-from-abroad includes some returning U.S. citizens."
    )
    ...
    if "moved_from_abroad_share" in sub.columns:
        ...
        print(
            "Median moved-from-abroad MOE share: "
            f"{sub['moved_from_abroad_moe_share'].median():.4f} "
            f"({sub['moved_from_abroad_moe_share'].median()*100:.2f}%)"
        )
        print(
            "High-MOE counties (MOE >= estimate): "
            f"{int(sub['moved_from_abroad_high_moe_flag'].fillna(False).sum())} / {len(sub)}"
        )
...
Outputs land in `data/analysis/` and `data/outcomes/analysis/` (parquet, CSV,
JSON, plain-text logs), depending on whether the artifact belongs to the early
causal stack or the later county-outcome/falsification tranche.
...
1. Median IRS `Total Migration-US` inflow share: about `4.49%`. [SOURCE: sources/immigration-causal/data/analysis/county_newcomer_comparison.parquet]
...
4. This ratio is best treated as a **lower-bound directional comparison**, not a precise burden multiple. IRS misses some domestic movers, while ACS moved-from-abroad includes some returning U.S. citizens, so the measured domestic-vs-foreign-origin gap is likely understated if the comparison is interpreted as domestic-origin versus foreign-origin newcomer flow. [INFERENCE]
...
1. IRS SOI counts tax-filer units and dependents, not a full resident universe. [SOURCE: sources/immigration-causal/scripts/analyze_internal_vs_immigrant_newcomers.py]
