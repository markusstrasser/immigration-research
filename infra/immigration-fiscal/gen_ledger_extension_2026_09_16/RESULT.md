...
**September 17 reconciliation and interpretation:** The [component check](../frontier_execution_2026_09_17/fiscal/RESULT.md) reproduces all 12 group/allocation accounts. Mexican G2's partial modeled balance is **+$7,698** per adult-year under all-member allocation; **−$8,286** is its gap from the white reference, not an absolute loss. Its gap from the overlapping all-native average is −$6,567. The full annual balance, lifetime account and marginal admission effect remain different unknowns. The later claim that marginal school cost must be lower than average cost is withdrawn: capacity expansion can make marginal cost higher. Historical calculations remain preserved.
