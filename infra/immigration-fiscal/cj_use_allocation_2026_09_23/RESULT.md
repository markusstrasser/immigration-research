...
- **Prisons, adjusted ACS custody.** Three estimates agree: the 2024 1-year ACS gives 0.1419, the 2020–2024 5-year ACS 0.1396, and the BJS prisons+jails check 0.1428. [2026-09-23: the BJS check is weaker than it looks. *Jail Inmates in 2023* records Hispanics at 14.4% of inmates against 18.4% of adults and 22.1% of adult arrests, flat since 2013, and BJS adjusts prisoner ethnicity but not jail ethnicity. At the arrest share the check would give 0.162, +$2.45bn on prisons. Dataset integrity audit, `crime.md` #3.] The BJS check takes its Hispanic total from BJS counts, 20.19% of prisoners and jail inmates in 2023, the same as the ACS institutional share (20.19%). It shares the ACS Mexican/Hispanic ratio. The raw ACS key is unstable: 0.1264 in the 1-year file and 0.1150 in the 5-year. The instability comes from ACS's residual "Other Hispanic" code (HISP 24). Its institutional rate at 18–64 is 3.9% for natives, 3.4 times the all-native rate. That points to institutional records with no detailed origin, not a real group. [DATA: `derived/acs_hisp_nativity_gq.csv`; INFERENCE]
...
- **National arrests by ethnicity after 2019.** The Crime Data Explorer totals carry race only, and the ethnicity endpoints return 404. [2026-09-23 correction: the repo already held CIUS 2023 and 2024 Table 43C by ethnicity (`nibrs_arrests_2026_09_16/arrests_by_ethnicity_2023.csv`, parse gates pass). Their Hispanic relative rate is 1.216 (2023) and 1.205 (2024) against the 1.145 used here, which raises the justice charge by $1.12bn (2024). The panel widened from 70% to 87–88% of the population and the Hispanic share rose, so the −$1.50bn carry-forward sensitivity points the wrong way. Dataset integrity audit, `crime.md` #1.]
