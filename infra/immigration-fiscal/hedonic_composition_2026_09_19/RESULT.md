...
> **Current interpretation, 2026-09-19:** The verdict below is retained as history. [Original-data replay](../../../research/immigration-hedonic-replay-2026-09-19.md) now recovers all six historical coefficients/SEs and stronger IV diagnostics; historical means and medians are both negative on identical rows. This modern exercise differs in outcomes, controls, sample, clustering and gravity. Its custom Hansen J calculation was incorrect and is now disabled; old J rejection labels are unverified. The earlier [bounded audit](../../../notes/immigration-hedonic-audit-evidence-2026-09-19.md) also corrects “every instrument,” the scalar-instrument objection, causal metro wording and the dollar-bound claim. Historical calculated outputs remain unchanged.
