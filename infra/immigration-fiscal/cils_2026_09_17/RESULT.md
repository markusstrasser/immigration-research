...
**September 17 qualification:** the [independent audit](../../../research/immigration-new-datasets-and-conclusions-2026-09-17.md) reproduces the descriptive cells but adds broad uncertainty and missing-record completion bounds. Selective retention supports a concern about downward bias; it does not establish “all rates are floors” or a precise Mexican-specific generational effect. Original evidence below retained; ladder108 governs these interpretations.
