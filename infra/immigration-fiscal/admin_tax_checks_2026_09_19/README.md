...
IRS Publication 4801, revised June 2026, supplies income-2023 sample estimates: salaries/wages $9,738.951 billion and income tax after nonrefundable credits $2,098.923 billion. The CPS income-2024 figures differ by +23.206% and -5.613%, respectively. These are explicitly **year-and-concept mismatch diagnostics**, not validation: no matched-year CPS file was available in the searched local caches; tax-return taxable wages omit nonfilers and differ from survey gross wages. FEDTAX_BC is before refundable credits and is the closer CPS tax concept, not FEDTAX_AC. [SOURCE: Publication 4801, p. 9, amounts in thousands](https://www.irs.gov/pub/irs-pdf/p4801.pdf). IRS federal tax liability is not FICA, withholding, collections, or all receipts. These sources have no published Mexican-origin administrative total.
