...
- **Key findings:**
  ...
  - Trend analysis: proportion of arrests involving undocumented immigrants was stable or decreasing 2012-2018. [SOURCE: same] *[Qualified 2026-09-23, audit A: identification that accrues after booking, documented for Texas in the crime-statistics bias memo, can by itself produce a falling undocumented share.]*
  - Results robust to: alternative population estimates, alternate undocumented classification, substituting convictions for arrests, substituting misdemeanors. [SOURCE: same] *[Qualified 2026-09-23, audit A: the direction survives, the magnitude does not. On the authors' most extreme recoding, every noncitizen without a DHS "legal" match counted as undocumented, total felony rates for 2012–18 are 761 undocumented against 1,046 US-born per 100,000, a ratio of 0.73 against about 0.40 in the headline (PNAS footnote \*\*). Undocumented arrestees never encountered by DHS who report US citizenship at booking stay in the native group; nobody has bounded that error, and it runs in the same direction.]*
...
- **Source quality:** Cato is a libertarian think tank (pro-immigration on policy grounds). However, the underlying data (Texas DPS) is the same administrative dataset used by Light & Miller's peer-reviewed PNAS study, and the findings are directionally consistent. Grade: [C2] — fairly reliable source, probably true given convergence with peer-reviewed work. *[Qualified 2026-09-23, audit A: shared data means shared classification error, so agreement with Light is not independent confirmation. Cato also counts DPS's "unknown or other" category as native-born by definition, and the same year's homicide conviction rate has moved from 8% below to 20% above the state rate between data extracts as later identifications accrued (CIS 2022, disputed by Cato). The homicide figure rests on about 50 convictions a year; the −26% is not a stable number.]*
...
5. **Author context:** Lott has a history of controversial methodological claims (the "More Guns, Less Crime" debate) and has faced criticism of his research practices in other domains. *[Withdrawn 2026-09-23, audit A: an ad hominem this memo did not apply to Cato's advocacy role; it carries no evidential weight.]*
...
*[Revised 2026-09-23 to D3, audit A `infra/immigration-fiscal/study_audit_2026_09_23/A_crime_levels.md`:]* Arizona and Texas both rest on agency status flags with a documented contamination, running in opposite directions, and this memo treated them unequally. The Arizona "non-US citizen and deportable" flag includes some deportable legal immigrants. Lott put that share at 10.5–21%, which still leaves undocumented convictions 94–121% above their population share [SOURCE: crimeresearch.org, 2018-02 response to Cato]. Cato's reversal used ICE detainers as an upper bound; its author later agreed with a critic that detainers are "much more likely to be an undercount" [SOURCE: cato.org blog, 2018-02-05, closing note]. No statement from the Arizona Department of Corrections confirming a coding error is on file. The Arizona sign is contested, not refuted; it is one non-peer-reviewed study with no independent reanalysis.
...
| 2 | US-born citizens >2x more likely to be arrested for violent crimes than undocumented immigrants in Texas | Same dataset; aggregate native-born denominator, not standardized to a common demographic distribution | HIGH on sign, MODERATE on magnitude (2026-09-23: 0.73 on the authors' extreme recode) | Light et al. 2020 | DESCRIPTIVE AGGREGATE COMPARISON |
| 3 | Undocumented immigrants 33% less likely to be institutionalized than US natives nationally | ACS data + IV; status imputed by a legal-first residual that misfires inside institutions (inflating the undocumented rate) while deportation removes convicted undocumented people from the stock (deflating it), net sign unknown (2026-09-23) | MODERATE | Gunadi 2019 | VERIFIED |
...
| 6 | Lott's Arizona study claiming higher rates faces a serious unresolved immigration-status classification critique | Multiple independent critiques (Cato, WaPo, Latino Decisions); no independent reanalysis in this memo | MODERATE-HIGH → MODERATE (2026-09-23: the critique's own bound was withdrawn by its author; sign contested, not refuted) | Nowrasteh 2022; WaPo 2018 | SUPPORTED CRITIQUE — not independent reanalysis |
...
- **2026-09-23 — Study 6 (Rumbaut) and any 2000-census immigrant incarceration rate qualified.** The 2000 census filled in birthplaces for most inmates whose birthplace was missing, and made nearly all of them US-born. Its count of institutionalized noncitizens (73,395) falls below the 89,676 noncitizens BJS counted in state and federal prisons alone. So 2000-census rates for young Mexico-born men run low: 0.62–0.70% as published, 1.3–1.6% after reassignment. The rates for US-born Mexican-origin men run high. The ordering (immigrant men below US-born men) survives the correction; the size of the gap roughly halves or more. Butcher and Piehl's 2000 cohort result inherits the same problem. Lane `crime_selection_cohorts_2026_09_23` (a8260f6), ladder 196.
