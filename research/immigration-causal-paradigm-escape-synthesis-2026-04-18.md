...
native-only, so this reframes the median-county denominator, but does not
identify school, shelter, legal, language, or wage incidence directly.
...
| 2026-06-16 | Changed the Saiz verdict from "closer to welfare loss" to a stronger renter-incidence warning; aggregate welfare remains unmeasured. See `immigration-conclusion-audit-running-fixes.md`. |
| 2026-06-16 | Reframed the domestic-vs-abroad newcomer comparison as a median-county denominator correction, not a direct local-burden or receiver-node pressure split. See `immigration-conclusion-audit-running-fixes.md`. |
