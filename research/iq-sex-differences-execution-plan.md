...
**Status:** raw item/process pass, framework-proxy pass, face-valid item audit, first DIF-style conditioning pass, the contamination-aware leave-out sensitivity pass, and the first process-style nuisance prototype are now executed in `research/iq-sex-differences-pisa2018-item-split.md`, `research/iq-sex-differences-pisa2018-framework-proxy.md`, `research/iq-sex-differences-item-face-validity-audit.md`, `research/iq-sex-differences-pisa2018-dif-proxy.md`, `research/iq-sex-differences-pisa2018-dif-leaveout.md`, and `research/iq-sex-differences-pisa2018-process-nuisance.md`. Current read: simple non-focal time/visit/count style does not materially compress the surviving residual family ordering, so the next serious measurement move is a real process-data rescoring / response-time DIF pass rather than another light proxy regression.
