# Mexican-origin fiscal account: objections and what the data say
...
## 3. "They pay into Social Security and Medicare and cannot collect."

Steel-man: unauthorized workers' payroll taxes are a pure transfer to everyone else.
Finding: both sides are already in the account. Employee and employer payroll taxes are
...
Finding: only income-year 2024 is a complete account. The adult ledger replicates on 2025.
...
[arrival cohorts](immigration-mexican-arrival-cohorts-2026-09-18.md); back-cast inputs]
