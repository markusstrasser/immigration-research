...
Current fiscal calculations: [repaired yearly and lifetime results](immigration-yearly-lifetime-cost-repair-2026-09-19.md). Annual deficits are $217.32bn under household sharing and $239.24bn under personal-source attribution in the expanded partial account; lifetime tables now use actual age components and conditional survival, with discount/allocation sensitivities. These are accounting scenarios, not causal policy costs. This release supersedes affected fiscal figures in the [September 19 cross-check](immigration-five-day-cross-check-2026-09-19.md); the birth-versus-arrival budget remains withdrawn. Narrative and essay writing are operator-owned.
