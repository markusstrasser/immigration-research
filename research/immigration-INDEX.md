...
|------|-------|----------------|
| `immigration-hedonic-replay-2026-09-19.md` | Original specification differs materially; withdraw exact-reproduction rating. Completed modern comparisons isolate clustering, gravity and decennial sample-rule choices. Original-data replay pending ICPSR download terms | Read before interpreting the modern housing lane as a replication failure or era change |
