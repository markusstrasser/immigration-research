...
| `immigration-dataset-roadmap-batch5-benefit-2026-06-24.md` | Batch 5 benefit (4) — NSF NSCG (immigrant scientists), SED (foreign PhD stay-rates), SEVIS + Open Doors (foreign-student contribution) |
| `immigration-dataset-roadmap-batch5-cost-2026-06-24.md` | Batch 5 direct-cost welfare-admin (3) — SSI / TANF / HUD subsidized housing by citizenship status |
