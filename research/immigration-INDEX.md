...
| [Native displacement onto transfers](immigration-native-displacement-to-transfers-2026-09-18.md) | 2026-09-18 | ADH design applied to immigration on 2000–2010 metros with a pre-1990-base instrument (F 16–29): SSI and public-assistance receipt move down, not up, every interval excludes an ADH-sign response, native employment null, survives natives-only outcome; but exogeneity fails 61/100 and placebos 42/59, so a null not a reversal; SSDI unreachable; 2021–24 surge pinned at 7.05M NIM / +4.96M stock / Mexico +0.45M and unstudiable with this instrument (F 0.002); earlier-Mexican wage effect −7.2% [−23.8, +9.5]; elasticity bound $1–26bn/yr | Any "immigrants push natives onto welfare/disability" claim; any Ottaviano–Peri earlier-immigrant wage number; sizing the Biden-era inflow |
| [Native sorting (Tiebout)](immigration-native-sorting-tiebout-2026-09-18.md) | 2026-09-18 | IRS SOI AGI migration by state 2011–23, ACS migration by nativity/income, 846-metro cross-section: California's net AGI outflow $17–21bn/yr since 2021 is ~$2bn of revenue, 1.1% of its Mexican-origin gap; Texas gains at the same share; high-AGI out-migration tracks the top-1% tax rate, not Mexican-origin share; metro displacement sign is a normalisation artefact (−0.013 on shares, +1.69 natives per arrival per capita), Peri–Sparber on fresh data; shift-share IV fails F gate | Any "natives are fleeing the gap states" or Borjas-2006 offset claim; before regressing native growth on immigrant shares |
| [Who pays the fiscal gap](immigration-fiscal-gap-incidence-who-pays-2026-09-18.md) | 2026-09-18 | Incidence of the −$263bn complete-account balance by level of government and across native households: 89% state-local / 11% federal under the central arm (51% federal with F per capita); $2,246 per native household a year, CA $8,498, TX $5,177; regressive as a share of income, top three deciles pay 60% of dollars; property-tax pass-through immaterial; the same matrix on whites' own −$391bn gives $3,334, so the distribution is group-invariant; federal aid to states not netted | Any "who actually pays for this" question; before quoting a per-taxpayer figure; choosing the F convention |
| [Employment-entry displacement, US metros](immigration-employment-entry-displacement-2026-09-18.md) | 2026-09-18 | Metro-level replication of the DSS native employment-entry estimand on ACS 2005–2023 with the past-settlement instrument and the JRS correction: 10-year IV −0.43 pp per pp [−1.28, +0.42], uninformative against the DSS-equivalent −0.6/−0.9; pooled 5-year instrument dead (F 3.6) because the national Mexico-born stock stopped growing after 2008; windows flip sign and the DSS-looking window fails a pre-trend placebo; JRS correction underidentified (corr 0.82, Shea R² 0.0007) as JRS report post-1970s; college control flat; byproduct metro × year foreign-born share panel on fixed 2013 CBSAs | Any US-data claim about native employment displacement by Mexican inflows since 2008; before running a shift-share instrument on recent Mexican inflows |
| [Institutions and liberal norms by generation](immigration-institutions-and-liberal-norms-by-generation-2026-09-18.md) | 2026-09-18 | GSS confidence in 13 institutions, Stouffer civil-liberties battery, policing, role of government, national identity, and ANES 2020/24 democratic-norms items by Hispanic and Mexican-origin generation, against whites overall, white conservatives and white non-graduates: G1 more confident than whites in 11 of 13 institutions and G3+ at parity; civil-liberties deficit closes to zero against white conservatives and non-graduates; police approval lower at every generation; role-of-government gap persists at a fifth of the white ideological spread; political-violence endorsement +10 pp at G3+, outside the white range; response-style and mode caveats; WVS7 Mexico-vs-US anchors in ANCHORS.md | Any "do they believe in institutions / Western principles" question; choosing the white comparator |
| [Mexico-born arrival cohorts](immigration-mexican-arrival-cohorts-2026-09-18.md) | 2026-09-18 | Cohort quality 1975–2024 on the IPUMS census/ACS panel and ACS 2023–24: less-than-HS share among new arrivals 82% → 33%, BA+ 3% → 22%, monotone; education-conditional wage residual vs whites U-shaped (1980s fall, then recovery to −0.31); migrants' schooling rose 2.37 years vs Mexico's 2.20, so selection is flat and the rise is Mexico's schooling expansion; return-migration bound; Mexican share of 2021–24 arrivals 14%, of FY2021 encounters 11% net of Title 42 repeats; ACS secundaria-as-high-school coding artifact | Any "earlier Mexican cohorts were better" or "the surge was Mexican" claim |
| [Consumer prices and native women's hours](immigration-consumer-price-and-native-hours-2026-09-18.md) | 2026-09-18 | The pro side's two largest native benefits priced: Cortes 2008 price elasticity on CEX 2024 spending by quintile and Cortes-Tessada 2011 hours, extrapolated to removing every Mexico-born HS dropout; $22bn a year central ($8.7bn fiscal), 7.5% of the reference gap; published-vs-working-paper elasticity discrepancy; two post-2008 studies find no price channel | Any "immigrants make services cheaper" or "free up native women's time" argument; sizing benefits against the fiscal gap |
| [Claim scorecard: Smith, Caplan, Decker, Nowrasteh](immigration-claim-scorecard-2026-09-18.md) | 2026-09-18 | 27 claims graded HARD / COORDINATE / AGREE against the repo's measurements (9/9/10); nobody retracted, Smith moved to selection and local costs without marking the headline withdrawn; the cleanest hits are the generational unit, the tax-side gap that kills keyhole welfare exclusion, and Decker's "must" against CBO per capita; wages and first-generation crime are theirs | Writing any rebuttal of the pro-low-skill commentators; choosing which claims to attack |
...
| [Essay angles from bookmarks](immigration-essay-angles-from-bookmarks-2026-09-16.md) | 2026-09-16 | 1,361 bookmarked posts read three ways against ladder 65–81: five angles to build (asymmetric error, trust, program fraud, incarceration by parental income, GDP per capita), four already measured, claims that would fail verification |
