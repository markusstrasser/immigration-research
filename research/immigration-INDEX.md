...
Latest cross-check: [September 19 result and assumption index](immigration-five-day-cross-check-2026-09-19.md) governs the affected September 16–19 headlines below. The expanded absolute total needs grant consolidation; the birth-versus-arrival budget is withdrawn; failed IV designs remain unresolved. Narrative and essay writing are operator-owned.
...
|------|-------|----------------|
| `immigration-clemens-pritchett-calibration-mexican-origin-2026-09-19.md` | Clemens–Pritchett transmission model reproduced and re-calibrated with repo Mexican-origin generation data: assimilation 0.010–0.013 (earnings) and 0.001–0.007 (fiscal) vs the paper's floor 0.026; transmission 0.42 vs 0.24; optimal migration rate turns negative on every economic outcome, magnitude collapse survives all arms | Any use of Clemens–Pritchett as evidence that institutional transmission is small; any "culture transmission" claim needing a parameter rather than a narrative |
...
| `immigration-lifetime-longevity-and-social-security-timing-2026-09-18.md` | Mortality and entitlement-timing sensitivities on period profiles; expanded-account endpoints inherit the September 19 consolidation defect; not cohort projections | Reusing lifetime balances or the longevity percentage |
...
| [Native sorting (Tiebout)](immigration-native-sorting-tiebout-2026-09-18.md) | IRS/ACS sorting descriptions are more associated with tax rates; moving motives unresolved and fiscal scale comparisons inherit account caveats | Explaining native migration or assigning its revenue cost |
| [Who pays the fiscal gap](immigration-fiscal-gap-incidence-who-pays-2026-09-18.md) | $2,246 per native household and 89% state-local are provisional imposed allocations; source account has unnetted intergovernmental transfers; causal incidence unestimated | Reusing household burden or payer-share figures |
