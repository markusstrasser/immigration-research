...
|------|-------|----------------|
| `immigration-hedonic-composition-amenity-2026-09-19.md` | Saiz–Wachter neighbourhood composition discount on 2013–2023 tracts: 3–6× smaller than the paper, ethnic not nativity, fails placebo and reverses with an independent price source (Zillow); dollars −$979 to +$464 per resident-year, sign set by measurement; metro demand effect +1.3% rents / +3.4% values per 1% inflow reproduces | Any attempt to dollarize neighbourhood composition or "compositional amenities"; reusing Saiz–Wachter's −0.25 for the present period |
