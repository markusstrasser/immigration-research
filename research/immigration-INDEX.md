...
| `immigration-mexican-origin-generation-incarceration-2026-09-16.md` | The 3.5× (Rumbaut 2000) traced and recomputed 2010–2023 from ACS PUMS: US-born Mexican-origin men 18–39 vs native whites 3.45×→1.72× (2.1× adjusted), now at the all-native rate; Mexican-origin population by generation (CPS 2024: 31/35/34%); low-skill origins ranked on incarceration, BA and mobility | Any "second generation counted as native" argument, the 3.5× figure, or a Mexican vs other-origin comparison |
