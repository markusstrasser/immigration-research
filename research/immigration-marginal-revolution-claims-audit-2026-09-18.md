...
| T4 | "Recent inflows of unauthorized migrants increase the vote share for the Republican Party... reduce local public spending, and shift it away from education towards law-and-order" (2023-12-02, endorsing) | Backlash adopted (Konstantinou–Roumanias; GSS). Composition: not reproduced on 3,126 counties 2007–2022, where the law-and-order-to-education ratio moves toward education or not at all and total spending per resident does not fall; the paper's own share specification has education at +0.23 (se 0.61) and the 2025 revision drops the share columns (ladder 141, 149) | AGREE on backlash; COORDINATE on the composition sentence (regraded 2026-09-18 late) |
