...
[DERIVATION] In dollars at the observed 40.9m headcount, giving the union the white reference's ages moves its shared balance from −$217.3bn to **−$339.6bn** (−$122.3bn); personal-source, −$239.2bn to −$339.2bn. The shared change is cash transfers including Social Security −$70.2bn, public medical −$80.2bn, institutions −$7.9bn, rest of federal −$7.5bn, K-12 +$30.9bn and all taxes +$11.7bn. Within institutions, under-65 cost falls $1.4bn and 65+ nursing cost rises $9.2bn (item N by band); police and courts are per capita here and do not vary with age, and victim costs are outside a fiscal account. The same number of white-reference residents at those ages runs −$49.9bn, so the like-for-like difference is −$289.6bn against −$167.4bn when each group keeps its own ages. [SOURCE: `derived/age_normalizations_by_category.csv`.]
