...
**Current layers: 2026-09-05 (52–64) and 2026-09-16 (65–74).** Entries below supersede the specified prior ratings. The dated earlier ladder is preserved in the historical section. A primary citation verifies a source claim; it does not automatically validate our causal inference, its transfer to another population or a local implementation. [SOURCE: [material audit](immigration-conceptual-audit-2026-09-05.md)] [SOURCE: [repair decision](../decisions/2026-09-05-material-inference-repair.md)]
...
67. **Mexican-origin population by generation, 2024: 12.1M / 13.8M / 13.1M (31/35/34%), 39.0M total; third-plus is understated by attrition.** CPS ASEC Table 4; 2005 was 40/31/29. Duncan–Trejo: 17% of third-generation Mexican-ancestry children do not identify as Hispanic, positively selected. Rating: **official survey count; attrition adjustment unquantified here**. [SOURCE: memo §4]
...
70. **The 2009–2021 incarceration decline was property and drug for both groups; drug possession is 3–5% of prisoners.** BJS: Hispanic state prisoners are 71% violent (white 55%), possession 2.7% (white 4.9%). Per capita, Hispanic property −57%, drug −58%, violent +5%; white property −55%, drug −32%, violent −31%. Age-specific male rates at 20–29 fell 46–65% for both with the Hispanic/white ratio unchanged near 2.9×. Violent stock lag, ageing and improved Hispanic coding in prison records are unquantified contributors to the Hispanic violent rise. Rating: **official tabulations; composition change verified, causes not**. [SOURCE: memo §8]
...
74. **Low-skill origin groups differ sharply on second-generation outcomes, and parental selectivity organises the ranking.** US-born institutionalization 2000 → 2023: Mexican 5.90 → 1.92, Salvadoran/Guatemalan 3.01 → 0.89/1.01, Vietnamese 5.60 → 0.30, Chinese 0.65 → 0.12, Cambodian/Laotian/Hmong 7.26 → 1.35/1.60/0.84 (white 1.71 → 1.12). Second-gen BA rates: Chinese 82%, Vietnamese 55%, Mexican 24%, white 43%. ABJP: Haitian and Jamaican sons at p25 are the only modern origins not out-mobilizing the US-born; Mexico keeps a >5 log-point second-gen earnings gap. Rating: **descriptive across three verified sources; small Asian-detail cells noisy**. [SOURCE: memo §5]
