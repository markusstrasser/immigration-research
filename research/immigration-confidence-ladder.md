...
**Current layers: 2026-09-05 (52–64) and 2026-09-16 (65–84).** Entries below supersede the specified prior ratings. The dated earlier ladder is preserved in the historical section. A primary citation verifies a source claim; it does not automatically validate our causal inference, its transfer to another population or a local implementation. [SOURCE: [material audit](immigration-conceptual-audit-2026-09-05.md)] [SOURCE: [repair decision](../decisions/2026-09-05-material-inference-repair.md)]
